...
public abstract class CarControllerBase : MonoBehaviour
{
    ...
    // Constantes de conversión (sacadas de UshiMath)
    protected const float MPSToKPH = 3.6f;
    protected const float KPHToMPS = 1f / 3.6f;
    ...
    public float ForwardSpeed => Vector3.Dot(_rigidbody.velocity, transform.forward);
    public float ForwardSpeedKPH => ForwardSpeed * MPSToKPH;

    public float Speed => _speed;
    public float SpeedKPH => Speed * MPSToKPH;
    ...
    protected virtual void FixedUpdate()
    {
        ...
        _forwardSpeed = Vector3.Dot(_rigidbody.velocity, _groundForward);
        _sidewaysSpeed = Vector3.Dot(_rigidbody.velocity, _groundSideways);
    ...
    {
        var forwardVel = Vector3.Dot(_rigidbody.velocity, transform.forward);
